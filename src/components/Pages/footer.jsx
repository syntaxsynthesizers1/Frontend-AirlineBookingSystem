          ...
          <MDBRow className="mt-3">
            <MDBCol md="3" lg="4" xl="3" className="mx-auto mb-4">
              <h6 className="text-uppercase fw-bold mb-4">
                <MDBIcon color="secondary" icon="gem" className="me-3" />FourFly Air Ways
              </h6>
            ...
            <MDBCol md="4" lg="3" xl="3" className="mx-auto mb-md-0 mb-4">
              ...
              <p>
                ...
                timileyinbamgbose7@example.com
              </p>
              <p>
                <MDBIcon color="secondary" icon="phone" className="me-3" /> 08069547786
              </p>
              <p>
                <MDBIcon color="secondary" icon="print" className="me-3" /> 08069547786
              </p>
            </MDBCol>
          </MDBRow>
        </MDBContainer>
